    ...
    <div className="wedding-contact-wrapper">
      ...
      <div className="banner-area">
        <div className="banner-text">
          ...
          <p>We bring dream weddings to life!</p>
        ...
        <div className="layout-columns">
          ...
          <div className="inquiry-form" id="contact-form">
            <div className="form-header">
              <h2>Say Hello!</h2>
              <p>Ready to plan your dream wedding? Let's start the conversation.</p>
            </div>
              ...
              <div className="input-wrapper">
                ...
                <div className="message-help">
                  ...
                  <div className="message-hint">
                    Include your wedding date, venue preferences, and any special requirements.
                  </div>
                </div>
              ...
              <div className="quick-contact-items">
                ...
                <div className="quick-contact-item">
                  ...
                  <div>
                    ...
                    <span>123 Wedding St, Love City, LC 12345</span>
                  </div>
                </div>
                <div className="quick-contact-item">
                  <span className="contact-icon">🕒</span>
